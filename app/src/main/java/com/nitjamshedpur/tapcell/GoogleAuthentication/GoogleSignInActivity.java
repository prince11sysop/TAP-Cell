package com.nitjamshedpur.tapcell.GoogleAuthentication;
...
import com.nitjamshedpur.tapcell.SharedPrefManager;
...
public class GoogleSignInActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this).load(R.drawable.cse).fit().into((ImageView)findViewById(R.id.iv_login));
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            SharedPrefManager sm = new SharedPrefManager(GoogleSignInActivity.this);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                try {
                    if (dataSnapshot.exists()) {
                        moveToHomeActivity();
                        Toast.makeText(GoogleSignInActivity.this, "Welcome to Ojass Dashboard! " + fName, Toast.LENGTH_LONG).show();
                    } else {
                        moveToRegisterActivity();
                        Toast.makeText(GoogleSignInActivity.this, "Hey " + fName + "! Let us know you better.", Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e) {
